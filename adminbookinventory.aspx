<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookinventory.aspx.cs" CodeFile="~/adminbookinventory.aspx.cs"  Inherits="BookManagementLibrary.adminbookinventory" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img id="imgview" src="book_inventory/books.png" style="height:auto; width:auto;"/>
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     ...
                     <div class="col-4">
                        <asp:Button ID="Button3" class="btn btn-lg btn-block btn-info" runat="server" Text="Update" OnClick="Button3_Click" />
                     </div>
                     <div class="col-4">
                                 ...
                                 <ItemTemplate>
                                    <div class="container-fluid">
                                       <div class="row">
                                          ...
                                          <div class="col-lg-2">
                                             <asp:Image class="img-fluid" ID="Image1" runat="server" ImageUrl='<%# Eval("book_img_link") %>'  style="height:auto; width:auto;" />
                                          </div>
                                       </div>
                                    </div>
                                 </ItemTemplate>
