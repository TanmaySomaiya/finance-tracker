<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminmembermanagement.aspx.cs" CodeFile="~/adminmembermanagement.aspx.cs" Inherits="BookManagementLibrary.adminmembermanagement" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100px" src="images/genuser.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                            <Columns>
